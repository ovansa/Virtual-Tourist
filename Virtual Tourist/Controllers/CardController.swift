...
//  Virtual Tourist
//
//  Created by Muhammed Ibrahim on 31/08/2020.
...
class CardController: UIViewController {
    ...
    @objc
    func handleCardTap(recognizer: UIGestureRecognizer) {
    ...
    func startInteractiveTransition(state: CardState, interval: TimeInterval) {
        if runningAnimations.isEmpty {
            animateTransitionIfNeeded(state: state, duration: interval)
        }
